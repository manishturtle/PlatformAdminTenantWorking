...
export type ThemeColor = 'blue' | 'purple' | 'green' | 'teal' | 'indigo' | 'amber' | 'red' | 'pink' | 'orange' | 'cyan' | 'deepPurple' | 'lime';
export type FontFamily = 'inter' | 'roboto' | 'poppins' | 'montserrat' | 'opensans' | 'underdog';
